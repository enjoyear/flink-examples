package com.chen.guo.state.queryable;
...
public class QueryableStateDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //Set 1 thread to receive incoming requests for proxy
    config.setInteger(QueryableStateOptions.PROXY_NETWORK_THREADS, 1);
    //Set 1 thread to receive incoming requests for state server
  ...
  public static class StatefulMap extends RichFlatMapFunction<Tuple2<Long, String>, Long> {
    ...
    public void open(Configuration conf) {
      ...
      /**
       * Set the name of the queryable state
       */
